...
DEFAULT_ACCOUNTS = [
    ...
    ("1040", "Employee Loan Receivable", Account.Type.ASSET, Account.Role.EMPLOYEE_LOAN_RECEIVABLE),
    ...
    ("2050", "Other Payroll Deductions Payable", Account.Type.LIABILITY, Account.Role.PAYROLL_DEDUCTIONS_PAYABLE),
