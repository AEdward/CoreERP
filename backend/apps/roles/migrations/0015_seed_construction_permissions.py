...
def reseed_default_roles(apps, schema_editor):
    # Same shape as 0003-0014: re-run the real seed helper for every
    # existing company so construction.view/construction.manage
    # (Section N: Construction) and the new Construction Manager role
...
class Migration(migrations.Migration):
    dependencies = [
        ("roles", "0014_seed_healthcare_permissions"),
    ]
