...
def reseed_default_roles(apps, schema_editor):
    # Same shape as 0003-0006: re-run the real seed helper for every
    # existing company so hotel.view/hotel.manage (Section J: Hotel &
    # Hospitality, ported from AEdward/MiranErp) apply retroactively too.
...
class Migration(migrations.Migration):
    dependencies = [
        ("roles", "0006_seed_expenses_permission"),
    ]
