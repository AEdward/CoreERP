...
def reseed_default_roles(apps, schema_editor):
    # Same shape as 0003-0008: re-run the real seed helper for every
    # existing company so conference/gym/laundry/spa/loyalty/pos.* apply
    # retroactively too (Section J satellite apps, ported from
    # AEdward/MiranErp).
...
class Migration(migrations.Migration):
    dependencies = [
        ("roles", "0008_seed_housekeeping_maintenance_permissions"),
    ]
