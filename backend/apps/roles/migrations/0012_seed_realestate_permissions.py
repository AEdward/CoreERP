...
def reseed_default_roles(apps, schema_editor):
    # Same shape as 0003-0011: re-run the real seed helper for every
    # existing company so realestate.view/realestate.manage (Section K:
    # Real Estate) and the new Property Manager role apply retroactively
    # too.
...
class Migration(migrations.Migration):
    dependencies = [
        ("roles", "0011_seed_manufacturing_permissions"),
    ]
