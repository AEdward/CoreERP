...
def reseed_default_roles(apps, schema_editor):
    # Same shape as 0003-0013: re-run the real seed helper for every
    # existing company so healthcare.view/healthcare.manage (Section M:
    # Healthcare) and the new Doctor / Hospital Administrator roles
...
class Migration(migrations.Migration):
    dependencies = [
        ("roles", "0013_seed_retail_permissions"),
    ]
