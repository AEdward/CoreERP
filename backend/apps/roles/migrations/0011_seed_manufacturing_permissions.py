...
def reseed_default_roles(apps, schema_editor):
    # Same shape as 0003-0007/0010: re-run the real seed helper for every
    # existing company so manufacturing.view/manufacturing.manage
    # (Section I: Manufacturing) and the new Production Manager role
...
class Migration(migrations.Migration):
    dependencies = [
        ("roles", "0010_seed_hospitality_roles"),
    ]
