...
def reseed_default_roles(apps, schema_editor):
    # Same shape as 0003/0004/0005: re-run the real seed helper for
    # every existing company so expenses.view/expenses.manage apply
    # retroactively too.
...
class Migration(migrations.Migration):
    dependencies = [
        ("roles", "0005_seed_calendar_permission"),
    ]
